  ...
  static String buildBaseName({
    ...
    if (allDistributors) {
      if (sameDay && hour != null) {
        ...
        name =
            'A7mal_ElMoz3at_$from';
      } else if (hour != null) {
        name =
            'A7mal_ElMoz3at_from_${from}_to_${to}_hour_${hour.toString().padLeft(2, '0')}';
      } else {
        name =
            'A7mal_ElMoz3at_from_${from}_to_$to';
      }
    } else {
      final safeDistributor =
          _toAsciiName(
        (distributorName ??
                'Moz3')
            .trim(),
      ...
      if (sameDay) {
        name =
            'A7mal_Moz3_${safeDistributor}_day_$from';
      } else {
        name =
