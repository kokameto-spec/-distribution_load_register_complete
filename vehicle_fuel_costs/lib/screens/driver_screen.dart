...
class _DriverScreenState extends State<DriverScreen> {
  ...
  Future<void> _start() async {
    ...
    try {
      final vehicle =
          await FirebaseService.instance.vehicleByCode(_code.text.trim());
      if (vehicle == null) {
          ...
          builder: (_) => AlertDialog(
            ...
            content: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'السيارة: ${vehicle.number} — ${vehicle.model} — ${vehicle.fuelType}',
                  ),
                ...
                child: Column(
                  children: [
                    ...
                    TextField(
                      ...
                      keyboardType: TextInputType.number,
                      decoration: const InputDecoration(
                        labelText: 'عداد السيارة عند التموين',
                        suffixText: 'كم',
                    ...
                    const SizedBox(height: 10),
                    const Text(
                      'سيتم فتح الكاميرا تلقائيًا لأربع صور بالترتيب المحدد.',
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: FilledButton.icon(
                    ...
                    label: const Text('فتح الكاميرا والتقاط الصورة'),
                  ),
                ),
                const SizedBox(height: 12),
                TextButton(
